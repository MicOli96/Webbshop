  ...
  if (product === null) {
    return (
      <Box component="main">
        <Container
          maxWidth="sm"
          sx={{ py: { xs: 8, sm: 10 }, textAlign: "center" }}
        >
          <Typography variant="h4" sx={{ mb: 1.5 }}>
            Varan hittades inte
          </Typography>
          <Typography sx={{ color: "text.secondary", mb: 4 }}>
            Den här varan finns inte längre i hyllan, eller så har länken
            skrivits fel.
          </Typography>
          <Button
            component={Link}
      ...
      <Container maxWidth="lg" sx={{ py: { xs: 4, sm: 6 } }}>
        ...
        >
          ...
          <Box>
            <Typography
              variant="h3"
              sx={{ fontSize: { xs: "1.8rem", sm: "2.2rem" }, mb: 1.5 }}
            >
              {product.title}
            </Typography>
            ...
            <Chip
              ...
              sx={{
                mb: 3,
                bgcolor: inStock
                  ? alpha(moomin.sage, 0.15)
                  : alpha(moomin.berry, 0.15),
